...
class TestSUR(unittest.TestCase):
    ...
    def test_visualizzaPagamenti(self):
        sur = SUR.getInstance()
        sur.inserimentoPrenotazione("Mario", "Rossi", "mario.rossi@gmail.com", "1234567890", 2, "2023-02-22", "19:00",
                                    1)
        sur.inserimentoPortata(1, [Portata(1, "Pizza Margherita", 5.0)])

        sur.effettuaPagamento(1)
        self.assertEqual(sur.visualizzaPagamenti(), None)
